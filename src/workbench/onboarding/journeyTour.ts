...
export const TOUR_BEATS: TourBeat[] = [
  ...
  },
  {
    ...
    kind: 'spotlight',
    selectors: [
      '[data-tour-target="character"] [data-tour-target="generate-button"]',
      '.generation-canvas-v2-node [data-tour-target="generate-button"]',
  ...
  },
  {
    ...
    mode: 'preview',
    kind: 'spotlight',
    selectors: ['[data-tour-target="captions"]'],
  },
  {
    id: 'export',
    mode: 'preview',
