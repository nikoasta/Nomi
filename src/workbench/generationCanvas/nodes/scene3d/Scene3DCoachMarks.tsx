...
type CoachStep = {
  ...
  fallback?: string
  titleKey: Scene3DI18nKey
  bodyKey: Scene3DI18nKey
}

const STEPS: readonly CoachStep[] = [
  {
    coach: 'add-button',
    titleKey: 'coach.scene.title',
    bodyKey: 'coach.scene.body',
  },
  {
    coach: 'mannequin-row',
  ...
  },
  {
    ...
    fallback: 'camera-row',
    titleKey: 'coach.move.title',
    bodyKey: 'coach.move.body',
  },
  {
    coach: 'export-button',
    titleKey: 'coach.export.title',
    bodyKey: 'coach.export.body',
  },
] as const satisfies readonly CoachStep[]
