...
export function SceneAddToolbar({
  ...
  const geometryItems: Array<{ kind: Scene3DGeometry; labelKey: Scene3DI18nKey; icon: Icon }> = [
    { kind: 'box', labelKey: 'geometry.box', icon: IconBox },
    { kind: 'sphere', labelKey: 'geometry.sphere', icon: IconSphere },
    { kind: 'cylinder', labelKey: 'geometry.cylinder', icon: IconCylinder },
    { kind: 'plane', labelKey: 'geometry.plane', icon: IconPlane },
  ]
  ...
  return (
    <div
      ...
      aria-label={t3d('toolbar.addAria')}
      onPointerDown={(event) => event.stopPropagation()}
    ...
    >
      {addMenuOpen ? (
        ...
        >
          ...
          >
            <IconMap2 size={15} />
            <span className="min-w-0 flex-1">{t3d('toolbar.templates')}</span>
          ...
          >
            <IconBox size={15} />
            <span className="min-w-0 flex-1">{t3d('toolbar.geometry')}</span>
            <IconChevronRight size={14} />
          </button>
          <button
            className={cn(
          ...
          >
            <IconPackage size={15} />
            <span className="min-w-0 flex-1">{t3d('toolbar.props')}</span>
            <IconChevronRight size={14} />
          </button>
          <button
            className={cn(
          ...
          >
            <IconUser size={15} />
            <span className="min-w-0 flex-1">{t3d('toolbar.mannequin')}</span>
            <IconChevronRight size={14} />
          </button>
          <button
            className={cn(
          ...
          >
            <IconBulb size={15} />
            <span className="min-w-0 flex-1">{t3d('toolbar.light')}</span>
          </button>
          <button
            className={cn(
              'inline-flex h-8 w-full items-center justify-start gap-2 rounded-nomi px-2',
          ...
          >
            <IconCamera size={15} />
            <span className="min-w-0 flex-1">{t3d('toolbar.camera')}</span>
          </button>
        </div>
      ) : null}
      {addMenuOpen && geometryOpen ? (
        <div
          ...
          role="menu"
          aria-label={t3d('toolbar.addGeometryAria')}
        >
      ...
      {addMenuOpen && templatesOpen ? (
        <div
          ...
          role="menu"
          aria-label={t3d('toolbar.applyTemplateAria')}
        >
          {SCENE_TEMPLATES.map((template) => (
            <button
              ...
              type="button"
              role="menuitem"
              title={t3d('toolbar.templateHint')}
              onClick={() => {
            ...
            >
              <IconMap2 size={15} />
              <span>{t3d(`template.${template}` as Scene3DI18nKey)}</span>
            </button>
          ))}
        </div>
      ) : null}
      {addMenuOpen && propsOpen ? (
        <div
          ...
          role="menu"
          aria-label={t3d('toolbar.addPropsAria')}
        >
          {PROP_KINDS.map((kind) => {
            ...
            return (
              ...
              >
                <Icon size={15} />
                <span>{t3d(`prop.${kind}` as Scene3DI18nKey)}</span>
              </button>
            )
          })}
        </div>
      ...
      {addMenuOpen && characterOpen ? (
        <div
          ...
          role="menu"
          aria-label={t3d('toolbar.addMannequinAria')}
        >
          <button
            className={cn(
              'inline-flex h-8 w-full items-center justify-start gap-2 rounded-nomi px-2',
          ...
          >
            <IconUser size={15} />
            <span>{t3d('toolbar.singleMannequin')}</span>
          </button>
          <button
            className={cn(
              'inline-flex h-8 w-full items-center justify-start gap-2 rounded-nomi px-2',
          ...
          >
            <IconUser size={15} />
            <span className="min-w-0 flex-1">{t3d('toolbar.crowd')}</span>
            <IconChevronRight size={14} />
          </button>
        </div>
      ) : null}
