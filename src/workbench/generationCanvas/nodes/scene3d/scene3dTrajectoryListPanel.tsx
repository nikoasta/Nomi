          ...
          >
            <div className="group/menu relative">
              ...
              >
                ...
                <span className="min-w-0 flex-1 truncate">{t3d('trajectory.addToGroup')}</span>
  ...
  return (
    <section className="flex h-full min-h-0 flex-col bg-[var(--nomi-paper)]">
      <div className="flex shrink-0 items-center justify-between px-3 py-2">
        <h3 className="m-0 text-caption font-medium text-[var(--nomi-ink)]">{t3d('trajectory.listTitle')}</h3>
              ...
              <div
                ...
                >
                  ...
                  <span className="min-w-0 truncate text-micro text-[var(--nomi-ink-40)]">
                    {groupName || t3d('trajectory.ungrouped')} · {t3d('trajectory.pointNodeCount', { points: trajectory.points.length, nodes: 0 }).split(' · ')[0]}
                  </span>
                </button>
                <button
                  className={cn(
