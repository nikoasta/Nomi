...
export const GENERATION_NODE_PLUGINS = defineGenerationNodePlugins([
    {
        ...
        quickAdd: true,
        agentCreatable: true,
        promptPlaceholder: "Enter text content...",
    },
    {
        kind: "character",
        label: "Character",
        ...
        promptPlaceholder: "Describe the character appearance, clothing, mood, and recognizable traits...",
    },
    {
        kind: "scene",
        label: "Scene",
        ...
        agentCreatable: true,
        providesImageReference: true,
        promptPlaceholder: "Describe the environment, light, composition, and atmosphere...",
    },
    {
        kind: "image",
        label: "Image",
    ...
    },
    {
        ...
        quickAdd: true,
        providesImageReference: true,
        promptPlaceholder: "Describe the keyframe image, action moment, and camera state...",
    },
    {
        kind: "video",
        label: "Video",
        ...
        quickAdd: true,
        agentCreatable: true,
        promptPlaceholder: "Describe this video shot, action, and rhythm...",
    },
    {
    ...
    },
    {
        ...
        catalogKind: "text",
        quickAdd: true,
        promptPlaceholder: "Record shot design, blocking, dialogue, or filming notes...",
    },
    {
        kind: "output",
        label: "Output",
        ...
        catalogKind: "text",
        quickAdd: true,
        promptPlaceholder: "Collect final output notes or delivery details...",
    },
    {
        kind: "panorama",
        label: "Panorama",
        ...
        quickAdd: true,
        providesImageReference: true,
        promptPlaceholder: "Upload or capture a panorama reference...",
    },
    {
        kind: "scene3d",
        label: "3D Scene",
        ...
        providesImageReference: true,
        promptPlaceholder: "Place models in the 3D scene and capture a reference...",
    },
    {
        kind: "whiteboard",
        label: "Whiteboard",
        ...
        quickAdd: true,
        providesImageReference: true,
        promptPlaceholder: "Draw a reference on the whiteboard, then describe the image to generate...",
    },
    {
        ...
        quickAdd: true,
        agentCreatable: true,
        promptPlaceholder: "Describe the 3D model to generate: shape, material, style...",
    },
    {
